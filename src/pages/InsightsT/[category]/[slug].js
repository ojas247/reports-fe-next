...
// export default function Insights({ blog_data, category, YouMayAlsoLike }) {
...
//     console.log("Breadcrumb SchemaCheck:", breadcrumbSchema);
//     console.log("Breadcrumb SchemaCheckList:", breadcrumbItemsList);
