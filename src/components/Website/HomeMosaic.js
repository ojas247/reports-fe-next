...
export default function HomeMosaic() {
  ...
  const images = [
    {
      src: "https://storage.googleapis.com/marketreports/Blogs/HomeMosaic/SS1.png",
      sector: "Insurance",
    ...
    {
      src: "https://storage.googleapis.com/marketreports/Blogs/HomeMosaic/SS3.png",
      sector: "Telecom",
      title: "Indian Aviation has a fleet size of 820 - 10% jump since FY23",
      icon: "bi-phone",
    ...
    {
      src: "https://storage.googleapis.com/marketreports/Blogs/HomeMosaic/SS4.png",
      sector: "Automobile",
      title: "Indian Aviation has a fleet size of 820 - 10% jump since FY23",
      icon: "bi-car-front",
    ...
    {
      src: "https://storage.googleapis.com/marketreports/Blogs/HomeMosaic/SS5.png",
      sector: "Railway",
      title: "Indian Aviation has a fleet size of 820 - 10% jump since FY23",
      icon: "bi-train-front",
    ...
    {
      src: "https://storage.googleapis.com/marketreports/Blogs/HomeMosaic/SS6.png",
      sector: "Milk & Dairy",
      title: "Indian Aviation has a fleet size of 820 - 10% jump since FY23",
      icon: "bi-cup-straw",
